...
|-----------|--------------|-----------------|-------------|------------|
| 🧱 **Bootstrap & Setup** | Repo-struktur, migrasjoner, pipelines *(f.eks. `ims-db-bootstrap`, `bootstrap-app-structure`)* | **GPT-5** | GPT-4o | Best i presisjon og multi-fil generering (TypeScript/SQL). |
